...
<div class="col-sm-3 col-md-2 sidebar">
	<ul class="nav nav-sidebar">
		<li class="active"><a href="/user/main.jsp">Main <span class="sr-only">(current)</span></a></li>
		...
		<li class="active"><a href="/user/userDetail?userId=brown"> 사용자 상세화면 </a></li>
		<li class="active"><a href="/user/prodList?page=1&pageSize=10">제품리스트 </a></li>
